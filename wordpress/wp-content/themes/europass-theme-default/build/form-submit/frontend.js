...
(function () {
  ...
  function isScopeComplete(scopeEl) {
    ...
    for (const el of fields) {
      ...
      if (tag === 'select') {
        var _el$value2;
        if (((_el$value2 = el.value) !== null && _el$value2 !== void 0 ? _el$value2 : '').trim() === '') return false;
        continue;
      }

      // текстові/числові/мейл/тощо
      if (((_el$value3 = el.value) !== null && _el$value3 !== void 0 ? _el$value3 : '').toString().trim() === '') return false;
    }
